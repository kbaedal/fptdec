...
#ifndef FPTDEC_H_INCLUDED
#define FPTDEC_H_INCLUDED
...
class decimal {
    public:
        ...
        // and separator commas in every place needed.
        std::string to_smoney(std::string suffix = " EUR") const;
		
		// Similar to to_smoney, but using decimal comma and separator points instead of
		// decimal point and separator commas.
        std::string to_sinvm(std::string suffix = " EUR") const;
